...
HD_PWD='/home/yumaly/workspace/lab4/vivado/lab4.runs/lab4_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab4_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab4_xbar_0.tcl
