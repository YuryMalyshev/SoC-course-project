...
proc create_root_design { parentCell } {
  ...
  # Create instance: AudioStream_0, and set properties
  set AudioStream_0 [ create_bd_cell -type ip -vlnv ttu.ee:user:AudioStream:1.0 AudioStream_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M04_AXI [get_bd_intf_pins AudioStream_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M04_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M05_AXI [get_bd_intf_pins Volume_Pregain_1/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M05_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M06_AXI [get_bd_intf_pins FILTER_IIR_1/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M06_AXI]
  ...
  connect_bd_net -net AudioStream_0_outStream [get_bd_pins AudioStream_0/outStream] [get_bd_pins Volume_Pregain_1/IN_SIG_L] [get_bd_pins Volume_Pregain_1/IN_SIG_R]
  ...
  connect_bd_net -net FILTER_IIR_0_FILTER_DONE [get_bd_pins FILTER_IIR_0/FILTER_DONE] [get_bd_pins xlconcat_0/In3]
  ...
  connect_bd_net -net FILTER_IIR_1_FILTER_DONE [get_bd_pins FILTER_IIR_1/FILTER_DONE] [get_bd_pins xlconcat_0/In5]
  connect_bd_net -net Net [get_bd_ports AC_SDA] [get_bd_pins zed_audio_0/AC_SDA]
  connect_bd_net -net Volume_Pregain_0_OUT_RDY [get_bd_pins Volume_Pregain_0/OUT_RDY] [get_bd_pins xlconcat_0/In2]
  ...
  connect_bd_net -net Volume_Pregain_1_OUT_RDY [get_bd_pins Volume_Pregain_1/OUT_RDY] [get_bd_pins xlconcat_0/In4]
  ...
  connect_bd_net -net clk_100_1 [get_bd_ports clk_100] [get_bd_pins zed_audio_0/clk_100]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins AudioStream_0/s00_axi_aclk] [get_bd_pins FILTER_IIR_0/s00_axi_aclk] [get_bd_pins FILTER_IIR_1/s00_axi_aclk] [get_bd_pins Volume_Pregain_0/s00_axi_aclk] [get_bd_pins Volume_Pregain_1/s00_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/M05_ACLK] [get_bd_pins ps7_0_axi_periph/M06_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins AudioStream_0/s00_axi_aresetn] [get_bd_pins FILTER_IIR_0/s00_axi_aresetn] [get_bd_pins FILTER_IIR_1/s00_axi_aresetn] [get_bd_pins Volume_Pregain_0/s00_axi_aresetn] [get_bd_pins Volume_Pregain_1/s00_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins ps7_0_axi_periph/M06_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins processing_system7_0/IRQ_F2P] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins FILTER_IIR_0/SAMPLE_TRIG] [get_bd_pins FILTER_IIR_1/SAMPLE_TRIG] [get_bd_pins xlconstant_0/dout] [get_bd_pins zed_audio_0/hphone_l_valid] [get_bd_pins zed_audio_0/hphone_r_valid_dummy]
  ...
  connect_bd_net -net zed_audio_0_new_sample [get_bd_pins xlconcat_0/In0] [get_bd_pins zed_audio_0/new_sample]
  connect_bd_net -net zed_audio_0_sample_clk_48k [get_bd_pins xlconcat_0/In1] [get_bd_pins zed_audio_0/sample_clk_48k]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C30000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs AudioStream_0/S00_AXI/S00_AXI_reg] SEG_AudioStream_0_S00_AXI_reg
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C50000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs FILTER_IIR_1/S00_AXI/S00_AXI_reg] SEG_FILTER_IIR_1_S00_AXI_reg
